...
export default function LoginPage() {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      setError(err.message || "Google OAuth is not configured. Please sign in with email.");
    ...
    <div className="min-h-screen w-screen bg-[#111111] text-gray-100 flex flex-col justify-center items-center p-4 selection:bg-emerald-500 selection:text-white relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-[#1c1c1c]/90 backdrop-blur-xl border border-gray-800 rounded-3xl p-8 shadow-2xl shadow-black/80 relative z-10 animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-sm text-gray-400 mt-1">Sign in to your LocalGPT cloud account</p>
        </div>

        {/* Error Alert */}
        {error && (
          <div className="mb-5 p-3.5 rounded-xl bg-red-950/60 border border-red-800/60 text-red-300 text-xs flex items-start gap-2.5 animate-in fade-in duration-150">
        ...
        <div className="relative my-5">
          ...
          <div className="relative flex justify-center text-[11px] uppercase">
            <span className="bg-[#1c1c1c] px-3 text-gray-500 font-medium">Or continue with email</span>
          </div>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 bg-[#141414] border border-gray-800 focus:border-emerald-500/80 focus:ring-2 focus:ring-emerald-500/20 rounded-xl text-sm text-gray-100 placeholder-gray-600 outline-none transition-all"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="••••••••"
                className="w-full pl-10 pr-10 py-2.5 bg-[#141414] border border-gray-800 focus:border-emerald-500/80 focus:ring-2 focus:ring-emerald-500/20 rounded-xl text-sm text-gray-100 placeholder-gray-600 outline-none transition-all"
              />
              <button
                type="button"
